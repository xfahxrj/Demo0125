var CanvasParticle = (function(){
	...
	function canvasSize(canvas){
		...
		canvas.width = window.innerWeight || document.documentElement.clientWidth || document.body.clientWidth||width;
		canvas.height = window.innerWeight || document.documentElement.clientHeight || document.body.clientHeight||height ;
	}
